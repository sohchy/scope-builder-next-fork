...
export function TextNode({ data, selected }: NodeProps) {
  ...
  const [openPicker, setOpenPicker] = useState<null | 'fg' | 'fs'>(null);
      ...
      >
        ...
        {isEditing && (
          <textarea
            ...
            className="nodrag absolute inset-0 w-full h-full bg-transparent outline-none resize-none p-2 text-center"
            style={{
              lineHeight: 1.25,
              color: shape.textColor || '#0f172a',
              fontSize: shape.textSize || 14,
