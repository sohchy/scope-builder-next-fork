  ...
  return (
    <>
          ...
          <div className="relative">
            ...
            >
              ...
              <span
                ...
                style={{ backgroundColor: shape.color || '#EAFBE3' }}
              />
            </button>
            {openPicker === 'bg' && (
              <PalettePopover
      ...
      <div
        ...
        className="w-full h-full flex items-center justify-center rounded-full border border-gray-400 shadow-[0px_4px_33.3px_0px_rgba(30,39,143,0.2)]"
        style={{ backgroundColor: shape.color || '#EAFBE3' }}
      >
        {!isEditing && (
          <div
        ...
        {isEditing && (
          <textarea
            ...
            className="nodrag w-full bg-transparent outline-none resize-none p-2 text-center"
            style={{
              lineHeight: 1.25,
              color: shape.textColor || '#0f172a',
              fontSize: shape.textSize || 14,
