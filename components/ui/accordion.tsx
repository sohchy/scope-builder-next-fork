...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <div className="bg-white size-6 rounded-full flex items-center justify-center relative">
          <ChevronDownIcon className="mb-1 text-muted-foreground pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200 " />
        </div>
      </AccordionPrimitive.Trigger>
