...
This pro example explaines how to implement different node shapes that could be used for flowcharts or diagrams. It contains a resizable custom node component that can render different shapes as well as common editor ui components such as a sidebar and an interactive minimap.
