/**
 * A copy of the Common Vocabulary page under its own title and URL.
 *
 * The entries below are still Common Vocabulary's — the page exists so the
 * do's and don'ts copy has somewhere to land, and each one replaces a term
...
export default function DoAndDontOfJtbdActivityPage() {
  return (
